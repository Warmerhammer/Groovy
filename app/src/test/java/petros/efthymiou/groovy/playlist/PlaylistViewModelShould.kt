...
class PlaylistViewModelShould : BaseUnitTest() {
    ...
    @Test
    fun getPlaylistsFromRepository(): Unit = runBlockingTest {
    ...
    @Test
    fun emitsPlaylistsFromRepository(): Unit = runBlockingTest {
        val viewModel = mockSuccessfulCase()
    ...
    @Test
    fun closeLoaderAfterPlaylistsLoad() : Unit = runBlockingTest {
        val viewModel = mockSuccessfulCase()
